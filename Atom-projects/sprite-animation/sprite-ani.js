...
(function() { "use strict";
  ...
  set is an array of values that corr espond to the location of sprite images in
  ...
  render = function() {
//fix later dont like this background -ethan
    /* Draw the background. */
    buffer.fillStyle = "black";/*"#7ec0ff";*/
    buffer.fillRect(0, 0, buffer.canvas.width, buffer.canvas.height);
    buffer.strokeStyle = "back"/*"#8ed0ff";*/
    buffer.lineWidth = 10;
    buffer.beginPath();
    buffer.moveTo(0, 0);
  ...
  sprite_sheet.image.src = "guy.png";// Start loading the image.
